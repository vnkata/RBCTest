...
public class DeclsVariable {
    ...
    public DeclsVariable(String variableName, String variablePath, String varKind, String decType, String repType,
            String enclosingVar) {
    ...
    public DeclsVariable(String variableName, String variablePath, String varKind, String decType, String repType,
            String enclosingVar, boolean isArray) {
        this.variableName = variablePath + "." + encodeVariableName(variableName);
        this.varKind = encodeVariableName(varKind);
    ...
    public String generateDtraceEnter(TestCase testCase) {
        ...
        if ((this.repType.equalsIgnoreCase(DOUBLE_TYPE_NAME) || this.repType.equalsIgnoreCase(BOOLEAN_TYPE_NAME)
                || this.repType.equalsIgnoreCase(INTEGER_TYPE_NAME))
    ...
    public String generateDtraceExit(TestCase testCase, JSONObject json, Boolean isElementOfArray) {
        ...
        primitiveTypes.contains(this.decType) && !varKind.equals(ARRAY_TYPE_NAME)) {
            ...
            if ((repType.equalsIgnoreCase(DOUBLE_TYPE_NAME) || repType.equalsIgnoreCase(INTEGER_TYPE_NAME)
                    || repType.equalsIgnoreCase(BOOLEAN_TYPE_NAME))
                    && value == null) {
                value = "nonsensical";
                isNonsensical = true;
            }
        ...
        } else { // If type = object or identifier of array (both array of objects and array of
                 // primitives)
