...
public class CreateTestConf {
    ...
    private static String openApiSpecPath = "spec/Stripe/spec.yaml"; // OAS file path
     ...
     * will be generated
     * 2. One or more filters specifying the operations for which test configuration
     * data must be created. Format: "path1:HTTPMethod1,path2:HTTPMethod2,..."
     */
