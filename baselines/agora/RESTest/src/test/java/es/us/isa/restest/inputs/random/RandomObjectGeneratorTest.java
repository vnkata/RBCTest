...
public class RandomObjectGeneratorTest {
    ...
    public void testConstructorWithoutArguments() {
        RandomObjectGenerator objGen = (RandomObjectGenerator) TestDataGeneratorFactory
                .createTestDataGenerator(generator);
    ...
    public void testConstructorWithFileArguments() {
        ...
        files.setName("files");
        files.setValues(Collections
                .singletonList("src/test/resources/restest-test-resources/compare1.postman_collection.json"));
    ...
    public void testNextValueAsString() {
        ...
        assertEquals("The next value is not the expected one", "{\"key1\":\"value1\",\"key2\":\"value2\"}",
                objGen.nextValueAsString());
    }
