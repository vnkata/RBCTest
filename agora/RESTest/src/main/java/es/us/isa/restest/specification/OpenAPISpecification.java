...
public class OpenAPISpecification {
	...
	/**
	 * Constructor to deserialize an OpenAPI v3 specification from a file (JSON or
	 * YAML).
	 * 
	...
	public void verifyServerUrls() {
		...
		if (specification.getServers() != null && !specification.getServers().isEmpty()) {
			specification.getServers().forEach(server -> System.out.println("Server found: " + server.getUrl()));
		} else {
