...
public class ParameterValues {
    ...
    private static String getEnterParameterValue(TestCase testCase, List<String> hierarchy) {
        ...
        if (value == null && bodyParameter != null && !bodyParameter.equals("")) {
            ...
            // System.out.println("hierarchy Parameter: " + hierarchy);
            // System.out.println("JSON Body Parameter: " + jsonBodyParameter);
    ...
    /**
     * Try to get the parameter value from a specific source (i.e.,
     * query/path/header/form). If the key is not found
     * in the parameter source map, the method tries to find a URL encoded version
     * of that key (e.g., convert image[0]
    ...
    public static String getValueOfParameterForDtraceFile(TestCase testCase, String variableName, String decType,
            String repType) {
        String value = null;
        ...
        if (primitiveTypes.contains(decType)) { // If primitive value
            ...
            if (repType.equals(STRING_TYPE_NAME) && value != null) {
                // Decode the parameter value. For example, "street+address" is decoded as
                // "street address" and "1%2C2" is decoded as "1,2"
            ...
            // value = decodeString(value);
            // // Convert the value to array (replace "," with spaces and add [])
            // value = generateDtraceEnterValueOfArray(testCase, value, decType,
            // variableName);
            // } else {
            // // If the array is null, return nonsensical
            // value = "nonsensical";
